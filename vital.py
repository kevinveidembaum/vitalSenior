...
def main(page: ft.Page):
    ...
    # Dicionário com perguntas e suas alternativas
    question_data = {
        "Você ou sua família estão preocupados com novos problemas de memória?": ["Sim", "Não"],
        "Você foi diagnosticado com demência, doença de Alzheimer ou um distúrbio neurocognitivo grave?": ["Sim", "Não"],
        "No último ano, quantas vezes você foi internado em um hospital?": ["Nenhuma", "1 a 2 vezes", "Mais de 2 vezes"],
        "Em geral, como você descreveria sua saúde?": ["Excelente", "Boa", "Regular", "Ruim"]
    }
